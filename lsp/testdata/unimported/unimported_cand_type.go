...
import (
	...
	"github.com/charlievieth/xtools/lsp/baz"
	_ "github.com/charlievieth/xtools/lsp/signature" // provide type information for unimported completions in the other file
)
