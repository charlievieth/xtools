...
import (
	...
	"github.com/charlievieth/xtools/lsp/foo" //@link(`github.com/charlievieth/xtools/lsp/foo`,`https://pkg.go.dev/github.com/charlievieth/xtools/lsp/foo?utm_source=gopls`)
