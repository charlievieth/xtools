...
import (
	...
	"github.com/charlievieth/xtools/lsp/command/commandmeta"
...
func rewriteAPI(_ []byte, api *source.APIJSON) ([]byte, error) {
	...
	fmt.Fprintf(&buf, "// Code generated by \"github.com/charlievieth/xtools/gopls/doc/generate\"; DO NOT EDIT.\n\npackage source\n\nvar GeneratedAPIJSON = ")
	if err := printsrc.NewPrinter("github.com/charlievieth/xtools/lsp/source").Fprint(&buf, api); err != nil {
		return nil, err
	}
